...
export const ResumeAnon = () => {
  // Contact info for Header component
  const contactInfo = [
    { href: "https://github.com/b44ken", label: "github/..." },
    { href: "https://boratto.ca", label: "... .ca" },
    { href: "tel:2269616479", label: "..." },
    { href: "mailto:brad@boratto.ca", label: "...@..." }
  ];

  return (
    <div className="mx-autofont-sans text-gray-800 leading-normal">
      {/* Header */}
      <Header name="My Resume" contactInfo={contactInfo} />
      ...
      <Bullets items={[
        ...
        "Led development (team of 3) when the project was officially adopted by CS Society."
      ]} />
      
      <Entry company="mysite.ca" link="https://boratto.ca" />
      <Bullets items={[
